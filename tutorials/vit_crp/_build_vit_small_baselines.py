...
nb.cells = [
    ...
    md(
        ...
        "",
        "`--funny-birds-clean-only` (default) filters out the ~41 % of train",
        "samples with part ablations. `--num-workers 0` if your `/dev/shm`",
        "is small (containers cap at 64 MB) — raise on a wider box.",
    ),
    code(
