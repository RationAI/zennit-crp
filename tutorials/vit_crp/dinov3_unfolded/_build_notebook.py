...
nb.cells = [
    md(
        ...
        "",
        "**3. Cache features and train a probe head.** Two-step CLI in",
        "`experiments/train_probe.py` — extract features once, train any",
        "number of head variants on top of the cache. Substitute your",
        "`<base>`, `<head>`, `<dataset>` in:",
        "",
        "```bash",
        ...
        "",
        "```bash",
        "uv run python experiments/train_probe.py cache vit_dinov3 funny_birds --kind tokens  # ~20 GB",
