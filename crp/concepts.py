...
# NOTE: The legacy POC class ``AttentionHeadConcept`` lived here through the
# ``transformer-multi-concept`` branch's iter-1/2 audit phase. It has been
# removed in iter-5 in favour of :mod:`crp.attention_concepts.HeadConcept`,
# which hooks the correct pre-attention `qkv_tap` rather than the post-`proj`
# attention output. See ``CURRENT_STATE.md`` for the audit finding that
